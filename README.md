...
[![run-tests](https://github.com/spatie/laravel-directory-cleanup/actions/workflows/run-tests.yml/badge.svg)](https://github.com/spatie/laravel-directory-cleanup/actions/workflows/run-tests.yml)
